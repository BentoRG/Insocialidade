...
import { CONFIG, resolveAsset } from './config.js?v=canvas11';
...
import { loadMap } from './canvas/map.js?v=canvas11';
import { createLocalPlayer } from './canvas/player.js?v=canvas11';
import { createGameEngine } from './canvas/engine.js?v=canvas11';
