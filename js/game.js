...
import { CONFIG, resolveAsset } from './config.js?v=canvas10';
...
import { loadMap } from './canvas/map.js?v=canvas10';
import { createLocalPlayer } from './canvas/player.js?v=canvas10';
import { createGameEngine } from './canvas/engine.js?v=canvas10';
